...
if (isset($_GET['eliminar'])) {
    $eliminaespecificcacao = $pdo->prepare("delete from vouchers where id = :id_eliminar");
...
$paramId = $_SESSION["id"];
$rsAll1 = $pdo->query("select *from vouchers");
$total_pages1 = ceil($rsAll1->rowCount() / $numItens1);
$rs1 = $pdo->query("select *from vouchers LIMIT $shift1, $numItens1;");
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    while ($row1 = $rs1->fetch(PDO::FETCH_OBJ)) {
                        ...
                        echo "<td>" . $row1->desconto . " %</td>";
                        echo "<td>" . $row1->nome . "</td>";
                        echo "<td>" . $row1->limite . "</td>";
